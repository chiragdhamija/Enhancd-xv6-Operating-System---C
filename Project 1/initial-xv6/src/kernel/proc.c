// get readcount reference : https://gist.github.com/bridgesign/e932115f1d58c7e763e6e443500c6561
#include "types.h"
#include "param.h"
#include "memlayout.h"
#include "riscv.h"
...
found:
  p->pid = allocpid();
  p->state = USED;
  p->read_counter = 0; // get readcount reference : https://gist.github.com/bridgesign/e932115f1d58c7e763e6e443500c6561
  ...
  // sigalarm
  p->cur_ticks = 0; // reference : https://xiayingp.gitbook.io/build_a_os/labs/lab-6-alarm
  p->ticks = 0;
  p->handler = -1; // handler fucntion initialized to some invalid value
  p->alarm_on = 0;
  p->alarm_tf = 0; // trapframe initialized to NULL i.e. 0 (NULL was not defined in)
